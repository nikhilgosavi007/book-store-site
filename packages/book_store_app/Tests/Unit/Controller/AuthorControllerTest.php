...
{
    /**
     * @var \NikhilGosavi\BookStoreApp\Controller\AuthorController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\NikhilGosavi\BookStoreApp\Controller\AuthorController::class)
    ...
    public function listActionFetchesAllAuthorsFromRepositoryAndAssignsThemToView()
    {
        ...
        $authorRepository = $this->getMockBuilder(\NikhilGosavi\BookStoreApp\Domain\Repository\AuthorRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
